...
def chat_with_llm_model1(user_input):
    ...
    response = requests.post(
        ...
        headers={"Authorization": f"Bearer {LLMFOUNDRY_TOKEN}:rajesh_bot"},
...
file_path = r"C:\Users\Rajesh Sankar\Downloads\new pro\city_name.xlsx"
...
with open(r"C:\Users\Rajesh Sankar\Downloads\new pro\prompt.txt", 'r') as file:
...
df.to_excel(r"C:\Users\Rajesh Sankar\Downloads\new pro\processed_city_name.xlsx", sheet_name=sheet_name, index=False)
